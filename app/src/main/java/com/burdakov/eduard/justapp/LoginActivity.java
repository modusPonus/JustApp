package com.burdakov.eduard.justapp;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> /*, View.OnClickListener */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignInButton = (Button) findViewById(R.id.B_sign_in);
        ...
        mRegistrationButton = (Button) findViewById(R.id.B_registration);
    ...
    private void attemptLogin() {
       ...
       // }
        ...
        if (cancel) {
            ...
            showProgress(true);
            if (viewId == R.id.B_sign_in)
                 {
                     Signin(mEmailView.getText().toString(),mPasswordView.getText().toString());
                 }else if (viewId == R.id.B_registration)
                 {
